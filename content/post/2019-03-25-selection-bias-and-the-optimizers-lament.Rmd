...
-------------------
If we knew that the true values are being generated from a _known_ distribution $P(\mu)$, the bias can be just _completely_ eliminated by turning the Bayesian crank. 
