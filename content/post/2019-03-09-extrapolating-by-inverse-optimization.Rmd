...
Alas it was not to be; the price vectors the grocer wants to plug into the trained regression model are well outside the ranges of the ones she provided the data scientist for training. Or what is the point of any such modeling? She is appalled by the resulting nonsensical predictions that her friend, a Ph.D. in data science no less, claims were produced by algorithms indistinguishable from the ones that in the near future will drive her around town.
